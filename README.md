...
To learn how to use Oplop itself and more details, such as choosing nicknames and a master password, see [BestPractices](#).
...
You can read more about what Oplop does (not) protect against in the [ThreatModel](#).
